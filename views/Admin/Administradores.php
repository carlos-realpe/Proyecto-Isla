    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <a href="index.php?c=Admin&a=VistaRegistrarAdmin" class="btn btn-dark"><i
                                class="bi bi-person-plus"></i> Registrar Administrador</a>
                        <div style="margin-top:10px;">
                        <input type="text" name="query" id="buscarCorreo" style="width:300px;" placeholder="Buscar por email" title="Enter search keyword" onkeyup="consultarDatosAjaxAdmin()">
                        </div>
                        ...
                        <table class="table datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="d-none d-lg-table-cell">Estado</th>
                                    <th scope="col">Email</th>
                                    <th scope="col">Acciones</th>
                                </tr>
                            </thead>
                            <tbody id="datosAdmins">
