    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <a href="index.php?c=Estudiante&a=VistaRegistrarEstudiante" class="btn btn-dark"><i
                                class="bi bi-person-plus"></i> Registrar Estudiante</a>
                        <div style="margin-top:10px;">
                            <input type="text" name="query" id="buscarCorreo" style="width:300px;"
                                placeholder="Buscar por email" title="Enter search keyword"
                                onkeyup="consultarDatosAjaxEstudiante()">
                        </div>
...
<script src="assets/js/EstudianteAdminAjax.js"></script>
